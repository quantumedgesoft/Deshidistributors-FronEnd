import TestimonialSlidder from "../../components/sliders/TestimonialSlider";
                ...
                <div className="position-relative">
                    ...
                    <div className="d-flex align-items-center flex-nowrap">
                        <div className="bg-secondary rounded">
                            <img src="/src/assets/img/testimonial-1.jpg" className="img-fluid rounded" style={{width: "100px", height: "100px"}} alt=""/>
                        </div>
