  ...
  return (
    ...
    <div className="container py-5">
      ...
      <p className="text-center mb-5">
        Explore exciting career opportunities with us. Apply now and be a part of our growing team!
      </p>
      ...
      <div className="row">
        {jobs.length > 0 ? (
            ...
            <div key={job.id} className="col-md-6 mb-4">
              <div className="card shadow-lg rounded">
                <div className="card-body">
                  ...
                  <a href={job.apply_link} className="btn btn-primary" target="_blank" rel="noopener noreferrer">
                    Apply Now
                  </a>
                </div>
              </div>
          ...
          <div className="col-12 text-center">
            <p className="text-muted">No job openings available at the moment.</p>
          </div>
        )}
      </div>
    </div>
