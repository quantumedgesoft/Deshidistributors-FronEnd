  ...
  return (
    <>
      ...
      <div className="container py-5">
        ...
        <p>
          At <strong>Deshi Distributors</strong>, we value customer
          satisfaction. If you are not completely satisfied with your purchase,
          we are here to help.
        </p>

        <h4>Returns</h4>
        <p>
          You have <strong>7 days</strong> to return an item from the date you
          received it.
        </p>
        ...
        <p>
          ...
          status of your refund. If approved, the refund will be processed to
          your original method of payment within a few days.
        </p>

        <h4>Shipping</h4>
        <p>
          You will be responsible for the shipping costs for returning your
          item. Shipping costs are non-refundable unless the return is due to an
          error on our part.
        </p>
