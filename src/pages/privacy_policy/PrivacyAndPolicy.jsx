...
const PrivacyAndPolicy = () => {
  return (
    <div className="container py-5 bg-gradient-to-b" style={{marginTop: "100px"}}>
    <div className="max-w-4xl mx-auto bg-white p-10 shadow-2xl rounded-2xl">
      <h1 className="text-4xl font-extrabold text-center text-gray-900 mb-4" style={{marginTop: "20px"}}>Privacy Policy</h1>
